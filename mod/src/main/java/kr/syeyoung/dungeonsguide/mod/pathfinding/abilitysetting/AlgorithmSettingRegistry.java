...
public class AlgorithmSettingRegistry {
    ...
    public static final AlgorithmSetting STANDARD_DEFAULT_ALGORITHM_SETTING = new AlgorithmSetting(null, null, null, 0, true, true, false, true, 14, false, false, 0.4, 61, 0.0625, false, true);
